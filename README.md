...
- `on_time_experiment_data/`: processed experimental data. Single-cell TopFlash data in `g.pkl` and the corresponding on-time condition in `t.pkl`. The file `optimal_priors.pkl` contains the optimal priors as a function of the effective noise. 
